...
_VoltageController_readVoltage:
	...
	inc	dptr
	movx	@dptr,a
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:54: return vc->target_voltage;
	mov	dptr,#_VoltageController_readVoltage_vc_65536_187
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	dph,r6
	mov	b,r7
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:72: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:74: float VoltageController_updateVoltage(VoltageController* vc) {
;	-----------------------------------------
...
_VoltageController_updateVoltage:
	...
	inc	dptr
	movx	@dptr,a
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:75: vc->current_voltage = VoltageController_readVoltage(vc);
	mov	dptr,#_VoltageController_updateVoltage_vc_65536_189
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	a,r7
	lcall	__gptrput
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:76: return vc->current_voltage;
	mov	dptr,#_VoltageController_updateVoltage_vc_65536_189
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	dph,r6
	mov	b,r7
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:77: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:79: bool VoltageController_isVoltageAbnormal(VoltageController* vc) {
;	-----------------------------------------
...
_VoltageController_isVoltageAbnormal:
	...
	inc	dptr
	movx	@dptr,a
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:80: VoltageController_updateVoltage(vc);
	mov	dptr,#_VoltageController_isVoltageAbnormal_vc_65536_191
	movx	a,@dptr
	mov	r5,a
	inc	dptr
...
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:82: if (vc->current_voltage < vc->target_voltage - 1.0f) {
	mov	dptr,#_VoltageController_isVoltageAbnormal_vc_65536_191
	movx	a,@dptr
	mov	r7,a
	inc	dptr
	...
	mov	a,r7
	jz	00102$
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:83: return true;
	mov	dpl,#0x01
	ret
00102$:
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:86: return false;
	mov	dpl,#0x00
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:87: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:89: void VoltageController_lockOutput(VoltageController* vc) {
;	-----------------------------------------
...
_VoltageController_lockOutput:
	...
	inc	dptr
	movx	@dptr,a
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:90: vc->is_locked = true;
	mov	dptr,#_VoltageController_lockOutput_vc_65536_194
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	a,#0x01
	lcall	__gptrput
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:91: vc->current_pwm_duty = PWM_RESOLUTION;
	mov	a,#0x0a
	add	a,r5
	mov	r2,a
	clr	a
	...
	mov	a,#0xff
	lcall	__gptrput
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:92: analogWrite(vc->pwm_pin, vc->current_pwm_duty);
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	lcall	__gptrget
	...
	movx	@dptr,a
	mov	dpl,r5
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:93: }
	ljmp	_analogWrite
;------------------------------------------------------------
...
;------------------------------------------------------------
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:95: void VoltageController_unlockOutput(VoltageController* vc) {
;	-----------------------------------------
...
_VoltageController_unlockOutput:
	...
	inc	dptr
	movx	@dptr,a
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:96: vc->is_locked = false;
	mov	dptr,#_VoltageController_unlockOutput_vc_65536_196
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	b,r7
	clr	a
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:97: }
	ljmp	__gptrput
;------------------------------------------------------------
...
;------------------------------------------------------------
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:99: float VoltageController_getTargetVoltage(const VoltageController* vc) {
;	-----------------------------------------
...
_VoltageController_getTargetVoltage:
	...
	inc	dptr
	movx	@dptr,a
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:100: return vc->target_voltage;
	mov	dptr,#_VoltageController_getTargetVoltage_vc_65536_198
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	dph,r6
	mov	b,r7
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:101: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:103: float VoltageController_getCurrentVoltage(const VoltageController* vc) {
;	-----------------------------------------
...
_VoltageController_getCurrentVoltage:
	...
	inc	dptr
	movx	@dptr,a
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:104: return vc->current_voltage;
	mov	dptr,#_VoltageController_getCurrentVoltage_vc_65536_200
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	dph,r6
	mov	b,r7
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:105: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:107: uint8_t VoltageController_getPWMDuty(const VoltageController* vc) {
;	-----------------------------------------
...
_VoltageController_getPWMDuty:
	...
	inc	dptr
	movx	@dptr,a
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:108: return vc->current_pwm_duty;
	mov	dptr,#_VoltageController_getPWMDuty_vc_65536_202
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	b,r7
	lcall	__gptrget
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:109: }
	mov	dpl,a
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:111: bool VoltageController_isLocked(const VoltageController* vc) {
;	-----------------------------------------
...
_VoltageController_isLocked:
	...
	inc	dptr
	movx	@dptr,a
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:112: return vc->is_locked;
	mov	dptr,#_VoltageController_isLocked_vc_65536_204
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	b,r7
	lcall	__gptrget
;	C:\Users\tonyp\Downloads\ch552-turbo-fan-ctrl\src\voltage_control.c:113: }
	mov	dpl,a
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
