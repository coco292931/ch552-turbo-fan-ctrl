...
;	C:\Users\tonyp\AppData\Local\Arduino15\packages\CH55xDuino\hardware\mcs51\0.0.23\cores\ch55xduino\USBhandler.c:508: UDEV_CTRL &= ~bUD_LOW_SPEED; // Select full speed 12M mode, default mode
	anl	_UDEV_CTRL,#0xfb
;	C:\Users\tonyp\AppData\Local\Arduino15\packages\CH55xDuino\hardware\mcs51\0.0.23\cores\ch55xduino\USBhandler.c:511: UDEV_CTRL = bUD_PD_DIS; // Disable DP/DM pull-down resistor
	mov	_UDEV_CTRL,#0x80
...
;	C:\Users\tonyp\AppData\Local\Arduino15\packages\CH55xDuino\hardware\mcs51\0.0.23\cores\ch55xduino\USBhandler.c:538: UEP0_DMA = (uint16_t)Ep0Buffer; // Endpoint 0 data transfer address
	mov	r6,#_Ep0Buffer
	mov	r7,#(_Ep0Buffer >> 8)
	mov	((_UEP0_DMA >> 0) & 0xFF),r6
	mov	((_UEP0_DMA >> 8) & 0xFF),r7
;	C:\Users\tonyp\AppData\Local\Arduino15\packages\CH55xDuino\hardware\mcs51\0.0.23\cores\ch55xduino\USBhandler.c:539: UEP1_DMA = (uint16_t)Ep1Buffer; // Endpoint 1 data transfer address
	mov	r6,#_Ep1Buffer
	mov	r7,#(_Ep1Buffer >> 8)
	mov	((_UEP1_DMA >> 0) & 0xFF),r6
	mov	((_UEP1_DMA >> 8) & 0xFF),r7
;	C:\Users\tonyp\AppData\Local\Arduino15\packages\CH55xDuino\hardware\mcs51\0.0.23\cores\ch55xduino\USBhandler.c:540: UEP2_DMA = (uint16_t)Ep2Buffer; // Endpoint 2 data transfer address
	mov	r6,#_Ep2Buffer
	mov	r7,#(_Ep2Buffer >> 8)
