...
;--------------------------------------------------------
	...
	.globl _ACC
	.globl _PSW
	.globl _pulseIn_PARM_3
	.globl _pulseIn_PARM_2
	.globl _pulseIn
;--------------------------------------------------------
...
;------------------------------------------------------------
;state                     Allocated with name '_pulseIn_PARM_2'
;timeout                   Allocated with name '_pulseIn_PARM_3'
;pin                       Allocated with name '_pulseIn_pin_65536_172'
;------------------------------------------------------------
;	C:\Users\tonyp\AppData\Local\Arduino15\packages\CH55xDuino\hardware\mcs51\0.0.23\cores\ch55xduino\wiring_pulsein.c:27: uint32_t pulseIn(uint8_t pin, __xdata uint8_t state, __xdata uint16_t timeout) {
;	-----------------------------------------
;	 function pulseIn
;	-----------------------------------------
_pulseIn:
	...
	ar1 = 0x01
	ar0 = 0x00
;	C:\Users\tonyp\AppData\Local\Arduino15\packages\CH55xDuino\hardware\mcs51\0.0.23\cores\ch55xduino\wiring_pulsein.c:271: );
...
failReturn0$:
	...
	mov	b,a                                  
	ret	                                     
;	C:\Users\tonyp\AppData\Local\Arduino15\packages\CH55xDuino\hardware\mcs51\0.0.23\cores\ch55xduino\wiring_pulsein.c:273: }
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
	.area XINIT   (CODE)
